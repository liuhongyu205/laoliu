        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php foreach($materialData as $k=>$v):?>
                            <li style="list-style: none;float: left;margin-right: 5px;overflow: hidden;border: 2px solid palegreen">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="sage" id="" placeholder="">
                    </div>
                </div>
                <div class="form-group">
